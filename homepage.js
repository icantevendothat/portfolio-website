document.addEventListener("DOMContentLoaded", function () {
    ...
    function draw() {
        ...
        const y = (canvas.height - videoHeight) / 3;
        ...
        if (sectionIndex !== -1) {
            ...
            ctx.fillStyle = "white";
            ctx.font = "23px Water Resistant Regular";
            ctx.textAlign = "center";
            ctx.fillText(sectionNames[sectionIndex], sectionX + (canvas.width / (videos.length * 2)), canvas.height - 275);
        }
